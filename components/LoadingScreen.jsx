    ...
    fillAnimations.forEach((anim, index) => {
      Animated.timing(anim, {
        ...
        if (index === fillAnimations.length - 1) {
          ...
          // For example, you can use navigation.navigate('Home') here
        }
      });
    });
  };
...
const styles = StyleSheet.create({
  ...
  loader: {
    ...
    borderWidth: 5,
    borderColor: '#00F45B',
    borderRightColor: '#00F45B', // Match the border color
    position: 'relative',
    flexDirection: 'row',
    overflow: 'hidden', // Ensure that the loaderPart does not overflow
  },
  loaderPart: {
